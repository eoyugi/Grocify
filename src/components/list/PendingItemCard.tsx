      ...
      <View className="flex-row items-start gap-3">
        ...
        <View className="flex-1">
          ...
          <View className="mt-3 flex-row items-center gap-2">
            ...
            >
              <Plus size={12} color="#3b5a4a" />
            </Pressable>
          </View>
        </View>

        {/* Right: Priority pill + Delete button stacked */}
        <View className="items-end gap-2">
          ...
          <Pressable
            className="h-9 w-9 items-center justify-center rounded-xl bg-red-600"
